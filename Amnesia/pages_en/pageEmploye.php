				...
				<div class="row">
					<div class="col d-flex flex-row">
						...
						<div class="user_box ml-auto ">
                           ...
                           <!--div class="user_box_login user_box_link"><button onclick="location.href='../index_en.phpl';">Déconnexion</button></div>
					...
					<div class="col d-flex flex-row">
						...
						<div class="user_box ml-auto ">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="#" onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Manage reservations</a>
                            ...
                            <div class="user_box_login user_box_link"><button onclick="location.href='logout.php';effacerCategorie();">LogoutLogout</button></div>
                            <div class="user_box_login user_box_link">
                                <div class="nav-item avatar dropdown">
                                    <a class="user_box_link dropdown-toggle" id="navbarDropdownMenuLink-55" data-toggle="dropdown"
                                      aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-lg-right dropdown-secondary" aria-labelledby="navbarDropdownMenuLink-55">
                                        ...
                                        <a class="dropdown-item" href="logout.php" onclick="effacerCategorie();">Logout</a>
                                     </div>
                                 </div>
                             </div>
						</div>

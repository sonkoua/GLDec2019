					...
					<div class="col d-flex flex-row">
						...
						<div class="user_box ml-auto ">
                            ...
                            <button class="dropdown-toggle" type="button" data-toggle="dropdown"
                              aria-haspopup="true" aria-expanded="false">administración</button>

                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="#" onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Crea una cuenta nueva</a>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item" href="#" id="admin" onclick="selectUsers(this);">Listado de administradores</a>
                              <a class="dropdown-item" href="#" id="employe" onclick="selectUsers(this);">Lista de empleados</a>
                              <a class="dropdown-item" href="#" id="client" onclick="selectUsers(this);">Listado de clientes</a>
                              <a class="dropdown-item" href="#">Usuarios discapacitados</a>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item" href="#">Listado de tours</a>
                            </div>
                            <!-- Basic dropdown -->
                            </div>
		...
		<form id="formEnregUtil" name="formEnregUtil" class="modal-content1 animate p-l-45 p-r-45 p-t-45 p-b-45">
			...
			<div class="form-row m-b-20">
				<div class="form-group col-md-5 m-l-25 input100-1" data-validate = "Username is reauired">
					...
					<input class="input100 " type="password" name="motpasse" id="motpasse" required="required" placeholder="">
					<span class="focus-input100" data-symbol="&#xf190;"></span>
				</div>
	
				<div class="form-group col-md-5 m-l-60 input100-1" data-validate="Password is required">
					<span class="label-input100">confirmación de contraseña</span>
					<input class="input100" type="password" name="pass" id="pass" required="required" placeholder="">
					<span class="focus-input100" data-symbol="&#xf190;"></span>
				</div>
			</div>
			...
			<div class="container-login100-form-btn">
				<div class="wrap-login100-form-btn">
                    ...
                    <input type="button" id="inscrireClient" class="login100-form-btn" value="Inscribe" onClick="enregistrerEmploye();">
				</div>
			</div>
